...
Revision ID: 6a2c9b49356b
Revises: 
Create Date: 2019-04-24 11:37:07.832431
...
def upgrade():
    ...
    sa.Column('bio', sa.String(length=4500), nullable=True),
    sa.Column('profile_pic_path', sa.String(), nullable=True),
    sa.Column('pass_secure', sa.String(length=300), nullable=True),
